...
public final class Score {
    ...
    // Add points to the current score and update high score if necessary
    ...
    // Reset current score to zero and reload high score from file
    public void reset() {
        score.setValue(0);
        reloadHighScoreFromFile();
    }

    // Reload high score from file
